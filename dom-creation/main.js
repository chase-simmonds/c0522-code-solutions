...
function renderPokemon(pokemon) {
  ...
  colThirdDiv.appendChild(pokemonCard);
  ...
  var pokeHeader = document.createElement('h2');
  pokeHeader.textContent = pokemon.name;
  pokemonCardText.appendChild(pokeHeader);
  ...
  pokemonCardText.appendChild(pokeParagraph);
